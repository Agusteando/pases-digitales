<template>
  <div class="glass-panel p-8 md:p-10 rounded-[2.5rem] flex flex-col h-full min-h-[400px]">
    ...
    <div class="flex-1 overflow-y-auto mt-6 custom-scrollbar pr-2 relative before:absolute before:inset-0 before:left-[23px] before:top-2 before:bottom-2 before:w-[2px] before:bg-gradient-to-b before:from-casita-green-light/40 before:via-iedis-teal/40 before:to-transparent">
